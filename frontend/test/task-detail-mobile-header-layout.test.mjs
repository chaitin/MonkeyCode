...
test("手机页头恢复官方紧凑尺寸", () => {
  ...
  assert.match(source, /size="icon-sm"[\s\S]*?className="border-transparent bg-background shadow-xs ring-1 ring-inset ring-border"[\s\S]*?aria-label=\{t\("taskDetail\.page\.mobileTools\.trigger"\)\}/);
