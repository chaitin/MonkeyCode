...
import { TaskflowVirtualMachineStatus } from "@/api/Api"
...
export default function TaskDetailPage() {
  ...
  React.useEffect(() => {
    ...
    if (task?.virtualmachine?.status !== undefined && task?.virtualmachine?.status !== TaskflowVirtualMachineStatus.VirtualMachineStatusPending) {
