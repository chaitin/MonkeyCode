const en = {
  ...
  managerRules: {
    description: "Manage enterprise global rules. Disabled or deleted rules are not injected into later tasks; existing sessions keep their original copies.",
    actions: {
      add: "New rule",
      edit: "Edit",
      delete: "Delete",
    ...
    fields: {
      ...
      contentPlaceholder: "Paste rule markdown",
    },
    toast: {
