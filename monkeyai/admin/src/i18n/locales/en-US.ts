export const enUS = {
  audit: {
    ...
    actions: {
      configure_cycle: "Configure billing cycle",
      configure_mode: "Configure billing mode",
      retry: "Retry settlement",
      resolve: "Resolve transaction",
      refund: "Refund",
      adjustments: "Adjust credits",
      wallet: "Bind wallet",
      billing_group: "Assign billing group",
      create: "Create",
      update: "Update",
      delete: "Delete",
      save: "Save",
      ...
      authorizations: "Start authorization",
      oauth_authorize: "Authorize",
      configure: "Configure",
      assign_billing_group: "Assign billing group",
      configure_quota: "Configure quota",
      configure_billing: "Configure billing",
      configure_pricing: "Configure pricing",
      configure_general: "Configure billing",
      configure_quota_policy: "Configure quota policy",
  ...
  pages: {
    ...
    models: {
      ...
      generate: "Generate",
      prompt: "Prompt",
      selectAspect: "Choose aspect ratio",
      imageCount: "Image count",
      referenceImages: "Reference/source images",
      mask: "Mask",
      taskStatus: "Task status",
      imageCapabilitiesUnavailable:
        "Unable to load image options for this provider.",
    ...
    membersAndGroups: {
      ...
      bulk: {
        ...
        addOne: "Add one",
        addMany: "Add multiple",
        title: "Add multiple members",
        singlePassword: "Initial password",
        cancel: "Cancel",
        createOne: "Create",
        creating: "Creating…",
        role: "Role",
        ...
        empty: "Enter at least one email.",
        tooMany:
          "Add up to {{count}} members at a time. Split this list into batches.",
        memberList: "Member list",
        previous: "Previous",
        adminPasswordHint:
          "Set a different initial password for each administrator (at least 12 characters).",
        email: "Email",
        name: "Name",
        password: "Initial password for {{email}}",
        passwordPlaceholder: "Initial password (at least 12 characters)",
        errors: {
          invalidEmail: "Invalid email address",
          duplicateEmail: "Duplicate email in this batch",
          existingEmail: "This email already exists",
          missingName: "Name is required",
          passwordTooShort:
            "Administrator password must be at least 12 characters",
          duplicatePassword:
            "Use a different initial password for each administrator",
        },
        progress: "Adding {{completed}} of {{total}}…",
        result: "{{succeeded}} added; {{failed}} need attention.",
        successResult: "Successfully added {{count}} members.",
        singleSuccess: "Member added successfully.",
        next: "Next",
        create: "Add {{count}} members",
      },
    ...
    billingSettings: {
      ...
      modelPricing: {
        title: "LLM charging rules",
        description: "Set LLM token credit prices.",
        inputToken: "Uncached input token cost",
        cachedInputToken: "Cached input token cost",
        outputToken: "Output token cost",
        inputTokenDescription:
          "{{credits}} credits per million uncached input tokens",
        cachedInputTokenDescription:
          "{{credits}} credits per million cached input tokens",
        outputTokenDescription: "{{credits}} credits per million output tokens",
        configure: "Configure",
        manageMultiplier: "Configure model multipliers",
        configureTitle: "Configure {{name}}",
        dialogDescription: "Set the credits consumed per million tokens.",
        valueLabel: "Credits",
        valueInvalid: "Enter a non-negative number with up to six decimals.",
        cancel: "Cancel",
        confirm: "Confirm",
        unit: "Credits consumed per million tokens",
      },
      toolPricing: {
        title: "Tool charging rules",
        description: "Set credits consumed per tool call.",
        manage: "Configure tool rates",
      },
      chargingMethod: {
        title: "Charging method",
        description: "Configure the resource charging strategy.",
        mode: "Charging method",
        modes: {
          disabled: "No charging",
          local: "Direct charging",
          remote: "Baizhi Cloud linked charging",
        },
        modeDescriptions: {
      ...
      quotaRefresh: {
        title: "Automatic credit refresh",
        description: "Automatically refresh member credits by cycle.",
        itemTitle: "Credit reset cycle",
        itemDescription: "{{cycle}} automatic reset",
        nextResetTitle: "Next reset time",
        resetNow: "Reset now",
        resetting: "Resetting…",
        resetSuccess: "Reset quotas for {{count}} members.",
        resetDialogTitle: "Reset member quotas now",
        resetDialogDescription:
          "Select the groups and members whose quotas should be reset immediately. Selecting a group includes its members.",
        resetTargets: "Groups and members",
        resetPlaceholder: "Select groups or members",
        resetSearch: "Search groups, names, or email addresses",
        resetNoResults: "No matching groups or members.",
        configure: "Configure",
        dialogTitle: "Configure credit reset cycle",
        dialogDescription:
          "Choose the automatic reset cycle for local charging.",
        cancel: "Cancel",
        confirm: "Confirm",
        cycle: "Reset cycle",
        cycleDescription:
