...
export const frFR = {
  ...
  pages: {
    ...
    models: {
      ...
      invocationKey: "Clé d’invocation",
      imageOperation: "Opération",
      generate: "Générer",
      prompt: "Consigne",
      selectAspect: "Choisir un format",
    ...
    membersAndGroups: {
      ...
      groupsTitle: "Groupes",
      ungroupedMembers: "Membres sans groupe",
      bulk: {
        addMember: "Ajouter un membre",
        addOne: "Ajouter une personne",
        addMany: "Ajouter plusieurs personnes",
        title: "Ajouter plusieurs membres",
        singlePassword: "Mot de passe initial",
        cancel: "Annuler",
        createOne: "Créer",
        creating: "Création…",
        role: "Rôle",
        ...
        previous: "Précédent",
        adminPasswordHint:
          "Définissez un mot de passe initial différent pour chaque administrateur (12 caractères minimum).",
        email: "E-mail",
        name: "Nom",
        password: "Mot de passe initial pour {{email}}",
        passwordPlaceholder: "Mot de passe initial (12 caractères minimum)",
        errors: {
          invalidEmail: "Adresse e-mail invalide",
          duplicateEmail: "Adresse en double dans cette liste",
          existingEmail: "Cette adresse existe déjà",
          missingName: "Le nom est obligatoire",
          passwordTooShort:
            "Le mot de passe administrateur doit contenir au moins 12 caractères",
          duplicatePassword:
            "Utilisez un mot de passe initial différent pour chaque administrateur",
        },
        progress: "Ajout de {{completed}} sur {{total}}…",
        result: "{{succeeded}} ajoutés ; {{failed}} à corriger.",
        successResult: "{{count}} membres ajoutés avec succès.",
        singleSuccess: "Membre ajouté avec succès.",
        next: "Suivant",
        create: "Ajouter {{count}} membres",
      },
      groupsDescription:
