...
export const jaJP = {
  ...
  pages: {
    ...
    membersAndGroups: {
      ...
      groupsTitle: "グループ",
      ungroupedMembers: "グループ未所属のメンバー",
      bulk: {
        addMember: "メンバーを追加",
        addOne: "1 人追加",
        addMany: "複数人追加",
        title: "メンバーを一括追加",
        singlePassword: "初期パスワード",
        cancel: "キャンセル",
        createOne: "作成",
        creating: "作成中…",
        role: "役割",
        ...
        previous: "前へ",
        adminPasswordHint:
          "管理者ごとに異なる初期パスワード（12 文字以上）を設定してください。",
        email: "メールアドレス",
        name: "名前",
        password: "{{email}} の初期パスワード",
        passwordPlaceholder: "初期パスワード（12 文字以上）",
        errors: {
          invalidEmail: "メールアドレスの形式が正しくありません",
          duplicateEmail: "この一括追加内でメールアドレスが重複しています",
          existingEmail: "このメールアドレスは既に存在します",
          missingName: "名前を入力してください",
          passwordTooShort: "管理者の初期パスワードは 12 文字以上必要です",
          duplicatePassword:
            "管理者ごとに異なる初期パスワードを設定してください",
        },
        progress: "{{total}} 人中 {{completed}} 人を追加中…",
        result:
          "{{succeeded}} 人を追加しました。{{failed}} 人は確認が必要です。",
        successResult: "{{count}} 人のメンバーを追加しました。",
        singleSuccess: "メンバーを追加しました。",
        next: "次へ",
        create: "{{count}} 人を追加",
      },
