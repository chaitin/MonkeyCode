...
func (*AgentSkill) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case agentskill.FieldIsForceDelivery, agentskill.FieldIsOrphan, agentskill.FieldIsDeleted:
			values[i] = new(sql.NullBool)
		case agentskill.FieldName, agentskill.FieldDescription, agentskill.FieldScopeType, agentskill.FieldScopeID:
