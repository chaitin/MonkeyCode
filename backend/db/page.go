...
func (_m *LicenseAuditQuery) Page(ctx context.Context, page, size int) ([]*LicenseAudit, *PageInfo, error) {
	cnt, err := _m.Count(ctx)
	if err != nil {
		return nil, nil, err
	}
...
func (_m *LicenseInstallationQuery) Page(ctx context.Context, page, size int) ([]*LicenseInstallation, *PageInfo, error) {
	cnt, err := _m.Count(ctx)
	if err != nil {
		return nil, nil, err
	}
...
func (_m *LicenseRecordQuery) Page(ctx context.Context, page, size int) ([]*LicenseRecord, *PageInfo, error) {
	cnt, err := _m.Count(ctx)
	if err != nil {
		return nil, nil, err
	}
