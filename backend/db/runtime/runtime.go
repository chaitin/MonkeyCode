...
func init() {
	...
	// mcptoolDescScope is the schema descriptor for scope field.
	mcptoolDescScope := mcptoolFields[4].Descriptor()
	// mcptool.DefaultScope holds the default value on creation for the scope field.
	mcptool.DefaultScope = mcptoolDescScope.Default.(string)
	// mcptool.ScopeValidator is a validator for the "scope" field. It is called by the builders before save.
	mcptool.ScopeValidator = func() func(string) error {
		validators := mcptoolDescScope.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// mcpupstreamDescScope is the schema descriptor for scope field.
	mcpupstreamDescScope := mcpupstreamFields[3].Descriptor()
	// mcpupstream.DefaultScope holds the default value on creation for the scope field.
	mcpupstream.DefaultScope = mcpupstreamDescScope.Default.(string)
	// mcpupstream.ScopeValidator is a validator for the "scope" field. It is called by the builders before save.
	mcpupstream.ScopeValidator = func() func(string) error {
		validators := mcpupstreamDescScope.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
