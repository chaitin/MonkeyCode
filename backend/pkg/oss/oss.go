...
// Unlike Presign (which presigns under a {prefix,filename} pair tied to
// upload flows), PresignGet takes the full object key verbatim — callers
// building download links should use this.
